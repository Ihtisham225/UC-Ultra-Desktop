    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          ...
          <Text style={text}>
            Welcome to <Link href={siteUrl} style={link}><strong>{siteName}</strong></Link>! Please confirm{' '}
            <Link href={`mailto:${recipient}`} style={link}>{recipient}</Link> to activate your account and start managing your shop.
          </Text>
          <Button style={button} href={confirmationUrl}>
            Verify email
          </Button>
          <Text style={footer}>
            If you didn't sign up for UCU, you can safely ignore this email.
          </Text>
        </Section>
