        ...
        <AuthProvider>
          <ShopProvider>
            ...
            <Routes>
              ...
              <Route path="/brands" element={<SubShell><RequireRole roles={["owner", "manager"]}><Brands /></RequireRole></SubShell>} />
              ...
              <Route path="/daybook" element={<SubShell><RequireRole roles={["owner", "manager"]}><Daybook /></RequireRole></SubShell>} />
